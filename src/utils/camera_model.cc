...
bool Plane::isPointInside(const Point& point) const {
  // V  // LOG(5) << "Plane: normal: " << normal_.transpose()
  // << " distance: " << distance_ << " point: " << point.transpose();
  // V  // LOG(5) << "Distance: " << point.dot(normal_) + distance_;
